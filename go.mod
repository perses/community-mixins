module github.com/perses/community-dashboards
...
require (
	...
	github.com/perses/plugins/markdown v0.9.0
	github.com/perses/plugins/prometheus v0.53.1
	github.com/perses/plugins/statchart v0.9.0
